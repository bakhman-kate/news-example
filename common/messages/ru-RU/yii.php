...
return [
    ...
    'Page not found.' => 'Запрошенный Вами адрес не существует - Вы можете воспользоваться меню и перейти на другие страницы сайта.',
    'The requested page does not exist.' => 'Запрошенный Вами адрес не существует - Вы можете воспользоваться меню и перейти на другие страницы сайта.',
    'You are not allowed to access this page.' => 'Доступ к данной странице запрещен.',
